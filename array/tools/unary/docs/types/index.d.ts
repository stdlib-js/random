...
/**
* Class for creating arrays filled with pseudorandom values drawn from a unary PRNG.
*/
declare class RandomArray<T, U> {
	...
	*/
	constructor( prng: UnaryPRNG<T, U>, dtypes: ArrayLike<DataType>, dtype: DataType );
	...
	* // returns <Float64Array>
	*/
	generate( len: number, param1: T, options?: Options ): OutputArray<U>;
	...
	* // returns true
	*/
	assign( param1: T, out: OutputArray<U> ): OutputArray<U>;
}
...
interface RandomArrayConstructor {
	...
	* // returns <Float64Array>
	*/
	new<T = unknown, U = unknown>( prng: UnaryPRNG<T, U>, dtypes: ArrayLike<DataType>, dtype: DataType ): RandomArray<T, U>;
	...
	* // returns <Float64Array>
	*/
	<T = unknown, U = unknown>( prng: UnaryPRNG<T, U>, dtypes: ArrayLike<DataType>, dtype: DataType ): RandomArray<T, U>;
}
