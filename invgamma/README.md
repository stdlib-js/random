...
> Generate pseudorandom numbers drawn from an [inverse gamma][@stdlib/random/base/invgamma] distribution.
...
```javascript
var invgamma = require( '@stdlib/random/invgamma' );
```

#### invgamma( shape, alpha, beta\[, options] )

Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from an [inverse gamma][@stdlib/random/base/invgamma] distribution.

```javascript
var arr = invgamma( [ 3, 3 ], 2.0, 5.0 );
// returns <ndarray>
```
...
var arr = invgamma( [ 2, 3, 3 ], alpha, beta );
// returns <ndarray>
```
...
var arr = invgamma( [ 3, 3 ], 2.0, 5.0, opts );
// returns <ndarray>
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from an [inverse gamma][@stdlib/random/base/invgamma] distribution.
...
var v = invgamma.assign( 2.0, 5.0, out );
// returns <ndarray>
...
#### invgamma.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from an [inverse gamma][@stdlib/random/base/invgamma] distribution.
...
var random = invgamma.factory( opts );
...
The function returned by the `factory` method has the same interface and accepts the same options as the `invgamma` function above.
