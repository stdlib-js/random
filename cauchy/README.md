...
> Generate pseudorandom numbers drawn from a [Cauchy][@stdlib/random/base/cauchy] distribution.
...
#### cauchy( shape, x0, gamma\[, options] )

Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from a [Cauchy][@stdlib/random/base/cauchy] distribution.

```javascript
var arr = cauchy( [ 3, 3 ], 2.0, 5.0 );
// returns <ndarray>
```
...
-   **shape**: output shape.
-   **x0**: location parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the specified output shape.
-   **gamma**: scale parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the specified output shape.
...
var x0 = array( [ [ [ 2.0 ] ], [ [ 10.0 ] ] ] );
// returns <ndarray>

var gamma = array( [ [ [ 5.0 ] ], [ [ 20.0 ] ] ] );
// returns <ndarray>

var shape = getShape( x0 );
// returns [ 2, 1, 1 ]

var arr = cauchy( [ 2, 3, 3 ], x0, gamma );
// returns <ndarray>
```
...
var arr = cauchy( [ 3, 3 ], 2.0, 5.0, opts );
// returns <ndarray>
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from a [Cauchy][@stdlib/random/base/cauchy] distribution.
...
-   **x0**: location parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the output [ndarray][@stdlib/ndarray/ctor].
-   **gamma**: scale parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the output [ndarray][@stdlib/ndarray/ctor].
-   **out**: output [ndarray][@stdlib/ndarray/ctor].

#### cauchy.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from a [Cauchy][@stdlib/random/base/cauchy] distribution.
...
var random = cauchy.factory( opts );
...
The function returned by the `factory` method has the same interface and accepts the same options as the `cauchy` function above.
