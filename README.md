...
```javascript
import { array, base, exponential, iterators, normal, sample, shuffle, streams, strided, tools, uniform } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random@esm/index.mjs';
```
