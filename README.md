...
```javascript
import { arcsine, array, base, beta, betaprime, binomial, cauchy, cosine, discreteUniform, erlang, exponential, f, gamma, gumbel, invgamma, iterators, kumaraswamy, laplace, levy, logistic, lognormal, negativeBinomial, normal, pareto1, sample, shuffle, streams, strided, tools, uniform, weibull } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random@esm/index.mjs';
```
