...
```javascript
import { arcsine, array, base, beta, exponential, iterators, normal, sample, shuffle, streams, strided, tools, uniform } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random@esm/index.mjs';
```
