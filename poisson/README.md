...
> Generate pseudorandom numbers drawn from a [Poisson][@stdlib/random/base/poisson] distribution.
...
#### poisson( shape, lambda\[, options] )

Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from a [Poisson][@stdlib/random/base/poisson] distribution.

```javascript
var arr = poisson( [ 3, 3 ], 2.0 );
// returns <ndarray>
```
...
-   **shape**: output shape.
-   **lambda**: mean parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the specified output shape.
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from a [Poisson][@stdlib/random/base/poisson] distribution.
...
-   **lambda**: mean parameter. May be either a scalar or an [ndarray][@stdlib/ndarray/ctor]. When providing an [ndarray][@stdlib/ndarray/ctor], the [ndarray][@stdlib/ndarray/ctor] must be [broadcast compatible][@stdlib/ndarray/base/broadcast-shapes] with the output [ndarray][@stdlib/ndarray/ctor].
-   **out**: output [ndarray][@stdlib/ndarray/ctor].

#### poisson.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from a [Poisson][@stdlib/random/base/poisson] distribution.
...
The function returned by the `factory` method has the same interface and accepts the same options as the `poisson` function above.
