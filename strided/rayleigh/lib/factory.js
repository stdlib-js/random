...
/**
* Returns a function for filling strided arrays containing pseudorandom numbers drawn from a Rayleigh distribution.
*
* @name factory
* @type {Function}
...
*
* var arr = rayleigh( out.length, [ 2.0 ], 0, out, 1 );
* // returns <Float64Array>
*
* var bool = ( arr === out );
* // returns true
